...
target "py311-cu128-torch2100" {
    dockerfile = "./dockerfiles/without-xformers/Dockerfile"
    tags = ["${REGISTRY}/${REGISTRY_USER}/runpod-base:${RELEASE}-python3.11-cuda12.8.1-torch2.10.0"]
    args = {
        BASE_IMAGE            = "nvidia/cuda:12.8.1-cudnn-devel-ubuntu22.04"
        REQUIRED_CUDA_VERSION = "12.8"
        PYTHON_VERSION        = "3.11"
...
target "py312-cu128-torch2100" {
    dockerfile = "./dockerfiles/without-xformers/Dockerfile"
    tags = ["${REGISTRY}/${REGISTRY_USER}/runpod-base:${RELEASE}-python3.12-cuda12.8.1-torch2.10.0"]
    args = {
        BASE_IMAGE            = "nvidia/cuda:12.8.1-cudnn-devel-ubuntu22.04"
        REQUIRED_CUDA_VERSION = "12.8"
        PYTHON_VERSION        = "3.12"
...
target "py311-cu128-torch2110" {
    dockerfile = "./dockerfiles/without-xformers/Dockerfile"
    tags = ["${REGISTRY}/${REGISTRY_USER}/runpod-base:${RELEASE}-python3.11-cuda12.8.1-torch2.11.0"]
    args = {
        BASE_IMAGE            = "nvidia/cuda:12.8.1-cudnn-devel-ubuntu22.04"
        REQUIRED_CUDA_VERSION = "12.8"
        PYTHON_VERSION        = "3.11"
...
target "py312-cu128-torch2110" {
    dockerfile = "./dockerfiles/without-xformers/Dockerfile"
    tags = ["${REGISTRY}/${REGISTRY_USER}/runpod-base:${RELEASE}-python3.12-cuda12.8.1-torch2.11.0"]
    args = {
        BASE_IMAGE            = "nvidia/cuda:12.8.1-cudnn-devel-ubuntu22.04"
        REQUIRED_CUDA_VERSION = "12.8"
        PYTHON_VERSION        = "3.12"
...
target "py313-cu128-torch2110" {
    dockerfile = "./dockerfiles/without-xformers/Dockerfile"
    tags = ["${REGISTRY}/${REGISTRY_USER}/runpod-base:${RELEASE}-python3.13-cuda12.8.1-torch2.11.0"]
    args = {
        BASE_IMAGE            = "nvidia/cuda:12.8.1-cudnn-devel-ubuntu22.04"
        REQUIRED_CUDA_VERSION = "12.8"
        PYTHON_VERSION        = "3.13"
...
target "py313-cu128-torch2100" {
    dockerfile = "./dockerfiles/without-xformers/Dockerfile"
    tags = ["${REGISTRY}/${REGISTRY_USER}/runpod-base:${RELEASE}-python3.13-cuda12.8.1-torch2.10.0"]
    args = {
        BASE_IMAGE            = "nvidia/cuda:12.8.1-cudnn-devel-ubuntu22.04"
        REQUIRED_CUDA_VERSION = "12.8"
        PYTHON_VERSION        = "3.13"
